...
const pageData = {
  ...
  "/src/pages/antistresshaki.html": {
    isHome: false,
  },
  "/src/pages/haki-detail.html": {
    isHome: false,
  },
};
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        antistresshaki: resolve(__dirname, "src", "pages", "antistresshaki.html"),
        hakidetail: resolve(__dirname, "src", "pages", "haki-detail.html"),
      },
      output: {
